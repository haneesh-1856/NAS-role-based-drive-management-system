/*
  ...
  ## Changes
  1. Update backup function to include ALL files and folders (including trashed)
  2. Ensure backup captures complete state of user's file system
  
  ## Details
  - Removes trashed filter from backup queries
  - Captures complete snapshot including trashed items
*/

-- ============================================================================
-- Updated backup function to include ALL files and folders
-- ============================================================================
